...
class Card extends AbstractAPI
{
    ...
    const API_GET_COLORS = 'http://api.weixin.qq.com/card/getcolors';
    const API_CREATE_CARD = 'http://api.weixin.qq.com/card/create';
    const API_CREATE_QRCODE = 'http://api.weixin.qq.com/card/qrcode/create';
    const API_SHOW_QRCODE = 'http://mp.weixin.qq.com/cgi-bin/showqrcode';
    const API_GET_CARD_TICKET = 'http://api.weixin.qq.com/cgi-bin/ticket/getticket';
    const API_CREATE_LANDING_PAGE = 'http://api.weixin.qq.com/card/landingpage/create';
    const API_DEPOSIT_CODE = 'http://api.weixin.qq.com/card/code/deposit';
    const API_GET_DEPOSIT_COUNT = 'http://api.weixin.qq.com/card/code/getdepositcount';
    const API_CHECK_CODE = 'http://api.weixin.qq.com/card/code/checkcode';
    const API_GET_HTML = 'http://api.weixin.qq.com/card/mpnews/gethtml';
    const API_SET_TEST_WHITE_LIST = 'http://api.weixin.qq.com/card/testwhitelist/set';
    const API_GET_CODE = 'http://api.weixin.qq.com/card/code/get';
    const API_CONSUME_CARD = 'http://api.weixin.qq.com/card/code/consume';
    const API_DECRYPT_CODE = 'http://api.weixin.qq.com/card/code/decrypt';
    const API_GET_CARD_LIST = 'http://api.weixin.qq.com/card/user/getcardlist';
    const API_GET_CARD = 'http://api.weixin.qq.com/card/get';
    const API_LIST_CARD = 'http://api.weixin.qq.com/card/batchget';
    const API_UPDATE_CARD = 'http://api.weixin.qq.com/card/update';
    const API_SET_PAY_CELL = 'http://api.weixin.qq.com/card/paycell/set';
    const API_MODIFY_STOCK = 'http://api.weixin.qq.com/card/modifystock';
    const API_UPDATE_CODE = 'http://api.weixin.qq.com/card/code/update';
    const API_DELETE_CARD = 'http://api.weixin.qq.com/card/delete';
    const API_DISABLE_CARD = 'http://api.weixin.qq.com/card/code/unavailable';
    const API_ACTIVATE_MEMBER_CARD = 'http://api.weixin.qq.com/card/membercard/activate';
    const API_ACTIVATE_MEMBER_USER_FORM = 'http://api.weixin.qq.com/card/membercard/activateuserform/set';
    const API_GET_MEMBER_USER_INFO = 'http://api.weixin.qq.com/card/membercard/userinfo/get';
    const API_UPDATE_MEMBER_CARD_USER = 'http://api.weixin.qq.com/card/membercard/updateuser';
    const API_CREATE_SUB_MERCHANT = 'http://api.weixin.qq.com/card/submerchant/submit';
    const API_UPDATE_SUB_MERCHANT = 'http://api.weixin.qq.com/card/submerchant/update';
    const API_GET_SUB_MERCHANT = 'http://api.weixin.qq.com/card/submerchant/get';
    const API_LIST_SUB_MERCHANT = 'http://api.weixin.qq.com/card/submerchant/batchget';
    const API_GET_CATEGORIES = 'http://api.weixin.qq.com/card/getapplyprotocol';
    const API_ACTIVATE_GENERAL_CARD = 'http://api.weixin.qq.com/card/generalcard/activate';
    const API_UPDATE_GENERAL_CARD_USER = 'http://api.weixin.qq.com/card/generalcard/updateuser';
