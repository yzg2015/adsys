...
{
    const API_OPEN_COMMENT = 'http://api.weixin.qq.com/cgi-bin/comment/open';
    const API_CLOSE_COMMENT = 'http://api.weixin.qq.com/cgi-bin/comment/close';
    const API_LIST_COMMENT = 'http://api.weixin.qq.com/cgi-bin/comment/list';
    const API_MARK_ELECT = 'http://api.weixin.qq.com/cgi-bin/comment/markelect';
    const API_UNMARK_ELECT = 'http://api.weixin.qq.com/cgi-bin/comment/unmarkelect';
    const API_DELETE_COMMENT = 'http://api.weixin.qq.com/cgi-bin/comment/delete';
    const API_REPLY_COMMENT = 'http://api.weixin.qq.com/cgi-bin/comment/reply/add';
    const API_DELETE_REPLY = 'http://api.weixin.qq.com/cgi-bin/comment/reply/delete';
