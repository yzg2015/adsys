...
{
    const API_LISTS = 'http://api.weixin.qq.com/cgi-bin/customservice/getkflist';
    const API_ONLINE = 'http://api.weixin.qq.com/cgi-bin/customservice/getonlinekflist';
    const API_DELETE = 'http://api.weixin.qq.com/customservice/kfaccount/del';
    const API_UPDATE = 'http://api.weixin.qq.com/customservice/kfaccount/update';
    const API_CREATE = 'http://api.weixin.qq.com/customservice/kfaccount/add';
    const API_INVITE_BIND = 'http://api.weixin.qq.com/customservice/kfaccount/inviteworker';
    const API_MESSAGE_SEND = 'http://api.weixin.qq.com/cgi-bin/message/custom/send';
    const API_AVATAR_UPLOAD = 'http://api.weixin.qq.com/customservice/kfaccount/uploadheadimg';
    const API_RECORDS = 'http://api.weixin.qq.com/customservice/msgrecord/getrecord';
    const API_MSG_LIST = 'http://api.weixin.qq.com/customservice/msgrecord/getmsglist';
