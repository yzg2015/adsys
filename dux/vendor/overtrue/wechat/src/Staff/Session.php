...
{
    const API_CREATE = 'http://api.weixin.qq.com/customservice/kfsession/create';
    const API_CLOSE = 'http://api.weixin.qq.com/customservice/kfsession/close';
    const API_GET = 'http://api.weixin.qq.com/customservice/kfsession/getsession';
    const API_LISTS = 'http://api.weixin.qq.com/customservice/kfsession/getsessionlist';
    const API_WAITERS = 'http://api.weixin.qq.com/customservice/kfsession/getwaitcase';
