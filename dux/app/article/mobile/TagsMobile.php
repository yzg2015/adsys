...
class TagsMobile extends \app\base\mobile\SiteMobile {
    ...
    public function index() {
        target($this->_middle, 'middle')->setParams($this->urlParams)->meta($this->urlParams['name'] .'相关文章', $this->urlParams['name'], url('index', ['name' => $this->urlParams['name']]))->data()->export(function ($data) {
            $this->assign($data);
