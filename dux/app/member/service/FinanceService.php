...
class FinanceService extends \app\base\service\BaseService {
    ...
    public function account($data) {
        $data = [
            ...
            'pay_no' => $data['pay_no'] ? html_clear($data['pay_no']) : $this->logNo(),
            ...
            'source_url' => html_clear($data['source_url']),
            'source_value' => html_clear($data['source_value']),
        ];
        ...
        $logData['source_value'] = $data['source_value'];
        $logData['source_url'] = $data['source_url'];
