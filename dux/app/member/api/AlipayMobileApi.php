...
class AlipayMobileApi implements PayNotifyInterface {

    /**
     * 异步回调
     */
    public function index() {
        echo target('member/AlipayMobile', 'pay')->notifyPay($this);
    }
    ...
    public function notifyProcess(array $data) {
        ...
        if(!target($callbackInfo['target'], 'service')->pay($orderNo, $data['amount'], '支付宝移动版', $data['transaction_id'], 0, 'alipay_mobile')) {
            $model->rollBack();
