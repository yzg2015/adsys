...
(function ($, owner) {
     ...
     * 导航栏
     */
    owner.nav = function ($el) {
        var $classBody = $($el).children('.class-body'),
            $classList = $classBody.children('.class-list');
        ...
        $classList.on('mouseover mouseleave', 'li', function (event) {
            if (event.type == "mouseover") {
    ...
    owner.getCart = function ($el) {
        ...
        app.ajax({
            ...
            success: function (data) {
                ...
                $($el).find('[data-num]').text(data.info.items);
                $($el).find('[data-price]').text(data.info.total);
...
(function ($, owner) {
    ...
    owner.addCart = function ($el) {
        var $layout = $($el), url = $layout.data('url'), params = $layout.data('params'), $count = $($layout.data('count'));
        Do('dialog', function () {
