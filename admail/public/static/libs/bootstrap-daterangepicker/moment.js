...
;(function (global, factory) {
    ...
    var prototypeMin = deprecate(
         'moment().min is deprecated, use moment.max instead. http://github.com/moment/moment/issues/1548',
         function () {
    ...
    var prototypeMax = deprecate(
        'moment().max is deprecated, use moment.min instead. http://github.com/moment/moment/issues/1548',
        function () {
            var other = local__createLocal.apply(null, arguments);
            if (this.isValid() && other.isValid()) {
                return other > this ? this : other;
