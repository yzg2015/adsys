...
<head>
    ...
    <title>跳转提示 | {:config('web_site_title')} - admail</title>
...
<div class="content pulldown text-muted text-center">
    ...
    由 <a class="link-effect" href="http://www.admail.com">admail</a> 强力驱动 <a class="link-effect" href="http://www.zrthink.com">dd</a> 倾情奉献
</div>
<!-- END Error Footer -->
