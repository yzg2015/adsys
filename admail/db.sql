...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`admail` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `admail`;

/*Table structure for table `d_admin_access` */

DROP TABLE IF EXISTS `d_admin_access`;

CREATE TABLE `d_admin_access` (
...
/*Data for the table `d_admin_access` */

/*Table structure for table `d_admin_action` */

DROP TABLE IF EXISTS `d_admin_action`;

CREATE TABLE `d_admin_action` (
...
/*Data for the table `d_admin_attachment` */

/*Table structure for table `d_admin_config` */

DROP TABLE IF EXISTS `d_admin_config`;

CREATE TABLE `d_admin_config` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `d_admin_hook_plugin` */

insert  into `d_admin_hook_plugin`(`id`,`hook`,`plugin`,`create_time`,`update_time`,`sort`,`status`) values (1,'admin_index','SystemInfo',1477757503,1477757503,1,1),(2,'admin_index','DevTeam',1477755780,1477755780,2,1);

/*Table structure for table `d_admin_icon` */

DROP TABLE IF EXISTS `d_admin_icon`;

CREATE TABLE `d_admin_icon` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `d_admin_icon` */

/*Table structure for table `d_admin_icon_list` */

DROP TABLE IF EXISTS `d_admin_icon_list`;

CREATE TABLE `d_admin_icon_list` (
...
/*Data for the table `d_admin_icon_list` */

/*Table structure for table `d_admin_log` */
...
/*Data for the table `d_admin_log` */

/*Table structure for table `d_admin_menu` */
...
/*Data for the table `d_admin_message` */

/*Table structure for table `d_admin_module` */

DROP TABLE IF EXISTS `d_admin_module`;

CREATE TABLE `d_admin_module` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `d_admin_module` */

insert  into `d_admin_module`(`id`,`name`,`title`,`icon`,`description`,`author`,`author_url`,`config`,`access`,`version`,`identifier`,`system_module`,`create_time`,`update_time`,`sort`,`status`) values (1,'admin','系统','fa fa-fw fa-gear','系统模块，admail的核心模块','admail','http://www.admail.com','','','1.0.0','admin.admail.module',1,1468204902,1468204902,100,1),(2,'user','用户','fa fa-fw fa-user','用户模块，admail自带模块','admail','http://www.admail.com','','','1.0.0','user.admail.module',1,1468204902,1468204902,100,1);

/*Table structure for table `d_admin_packet` */

DROP TABLE IF EXISTS `d_admin_packet`;

CREATE TABLE `d_admin_packet` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `d_admin_packet` */

/*Table structure for table `d_admin_plugin` */

DROP TABLE IF EXISTS `d_admin_plugin`;

CREATE TABLE `d_admin_plugin` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `d_admin_plugin` */

insert  into `d_admin_plugin`(`id`,`name`,`title`,`icon`,`description`,`author`,`author_url`,`config`,`version`,`identifier`,`admin`,`create_time`,`update_time`,`sort`,`status`) values (1,'SystemInfo','系统环境信息','fa fa-fw fa-info-circle','在后台首页显示服务器信息','蔡伟明','http://www.caiweiming.com','{\"display\":\"1\",\"width\":\"6\"}','1.0.0','system_info.ming.plugin',0,1477757503,1477757503,100,1),(2,'DevTeam','开发团队成员信息','fa fa-fw fa-users','开发团队成员信息','蔡伟明','http://www.caiweiming.com','{\"display\":\"1\",\"width\":\"6\"}','1.0.0','dev_team.ming.plugin',0,1477755780,1477755780,100,1);

/*Table structure for table `d_admin_role` */
...
/*Data for the table `d_admin_role` */

insert  into `d_admin_role`(`id`,`pid`,`name`,`description`,`menu_auth`,`sort`,`create_time`,`update_time`,`status`,`access`,`default_module`) values (1,0,'超级管理员','系统默认创建的角色，拥有最高权限','',0,1476270000,1468117612,1,1,0);

/*Table structure for table `d_admin_user` */

DROP TABLE IF EXISTS `d_admin_user`;
...
/*Data for the table `d_admin_user` */

insert  into `d_admin_user`(`id`,`username`,`nickname`,`password`,`email`,`email_bind`,`mobile`,`mobile_bind`,`avatar`,`money`,`score`,`role`,`group`,`signup_ip`,`create_time`,`update_time`,`last_login_time`,`last_login_ip`,`sort`,`status`) values (1,'admin','超级管理员','$2y$10$Brw6wmuSLIIx3Yabid8/Wu5l8VQ9M/H/CG3C9RqN9dUCwZW3ljGOK','',0,'',0,0,'0.00',0,1,0,0,1476065410,1523170951,1523170951,2130706433,100,1);
